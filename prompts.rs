...
pub fn how_to_unlock() {
    ...
    const LOSS_MSG: &str = "
        You scanned your keycard and the lock
        rejected it. The intruder noticed and just
        squeaked again, completely unbothered. They
        know that you want to foil the plans, so
        they swiftly pushed a bunch of heavy
...
pub fn face_intruder() {
    println!(
		...
		\"oh i'm just looking for stickers\", she
		replies joyfully!
        ...
        \"eh okay but i just want stickerrrz\"
